...
/** \brief Permite obtener un puntero al elemento que se encuentra en el índice especificado
 *
 * \param this LinkedList* Puntero a la lista
    ...
    if(this != NULL && pFunc != NULL && order >= 0 && order <= 1)
    {
		for(i = 0; i < ll_len(this-1);i++)
		{
			for(j = i+1; j < ll_len(this);j++)
			{
				...
				if((pFunc(pElementoUno,pElementoDos) > 0 && order == 1) || (pFunc(pElementoUno,pElementoDos) < 0 && order == 0))
				{
...
/**
 * @brief Completa un campo del elemento, recibiendo como parámetro la función que sera la encargada de calcular el valor de ese campo.
 *
...
/**
 * @brief Filtra la lista con una condición, recibiendo como parámetro la función que sera la encargada de decidir si cada elemento
 *  	  cumple la condición (1) o no (0) y si se agrega a una nueva lista filtrada.
 *  	  Verificando que tanto el puntero this como el puntero a la funcion fn sean distintos de NULL.
 *
 * @param this Puntero a la lista
 * @param fn Puntero a la funcion
 * @return (NULL) Error: Si el puntero a la lista y la funcion son NULL
