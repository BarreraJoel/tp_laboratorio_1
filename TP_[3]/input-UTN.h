 ...
 *
 * @param cadena puntero al array de telefono
...
/**
 * @brief Recibe un texto y valida que sea alfanumerico
 *
 * @param cadena puntero al array del texto alfanumerico
 * @param mensaje que se imprime para que un usuario ingrese una calle
 * @param mensajeError mensaje que se imprime cuando un usuario ingreso algo no valido
 * @param minimo cantidad minima permitida
 * @param maximo cantidad maxima permitida
 * @param reintentos cantidad de intentos que tiene el usuario
 * @return Retorna -1 [Sin intentos] - 1 [OK]
 */
int utn_getTextoAlfanumerico(char* cadena, char* mensaje, char* mensajeError, int minimo, int maximo, int reintentos);
